...
function Pad({
  ...
  return (
    <button
      ...
      className="relative flex aspect-square select-none items-center justify-center rounded-lg border-2 transition-all duration-75 active:scale-95 disabled:opacity-40 disabled:active:scale-100"
      style={{
